...
const Settings = () => {
  ...
  type SettingsCategory = keyof typeof settings;
  type SettingsKey<C extends SettingsCategory> = keyof typeof settings[C];

  const updateSetting = <C extends SettingsCategory, K extends SettingsKey<C>>(
    category: C,
    key: K,
